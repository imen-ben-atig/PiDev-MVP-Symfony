 ...
 */
final class Version20230215184851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE repons (id INT AUTO_INCREMENT NOT NULL, id_reclamation_id INT NOT NULL, date_rep DATE NOT NULL, status_rep INT NOT NULL, relation VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_BC3CBF7A100D1FDF (id_reclamation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
